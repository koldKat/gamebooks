...
import { updateCoinsDisplay, refreshCoinsDisplay, COIN_SVG } from './shop.js?v=32';
import { renderBooksXpSummary } from './profile.js?v=48';
import { _broadcastLiveEvent } from './livetab.js?v=37';
import { _scheduleLiveUiRefresh } from './notif.js?v=28';
