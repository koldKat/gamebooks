...
import { getToken, getUsername } from './state.js?v=11';
import { updateCoinsDisplay, refreshCoinsDisplay, COIN_SVG } from './shop.js?v=41';
import { renderBooksXpSummary } from './profile.js?v=57';
import { _broadcastLiveEvent } from './livetab.js?v=46';
import { _scheduleLiveUiRefresh } from './notif.js?v=39';
