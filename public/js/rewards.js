...
import { updateCoinsDisplay, refreshCoinsDisplay, COIN_SVG } from './shop.js?v=42';
import { renderBooksXpSummary } from './profile.js?v=58';
import { _broadcastLiveEvent } from './livetab.js?v=47';
import { _scheduleLiveUiRefresh } from './notif.js?v=40';
