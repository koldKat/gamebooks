...
import { getToken, getUsername } from './state.js?v=14';
import { updateCoinsDisplay, refreshCoinsDisplay, COIN_SVG } from './shop.js?v=100';
import { renderBooksXpSummary } from './profile.js?v=115';
import { _broadcastLiveEvent } from './livetab.js?v=110';
import { _scheduleLiveUiRefresh } from './notif.js?v=97';
