...
import { openPublicProfile, openPublicSeriesRun, openPublicRun } from './public-profile.js?v=32';
import { openCoverActivity, openSeriesActivity } from './covers.js?v=50';
...
export async function loadFeed() {
  ...
  try {
    ...
    let html = '';
    if (pinned) {
      html += `<fieldset class="feed-pinned-card"><legend class="feed-pinned-legend"><svg class="feed-pin-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="17" x2="12" y2="22"/><path d="M5 17h14v-1.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V6h1a2 2 0 0 0 0-4H8a2 2 0 0 0 0 4h1v4.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24Z"/></svg>${escapeHtml(pinned.title)}</legend><div class="feed-pinned-body">${formatAnnBody(pinned.body)}</div></fieldset>`;
    }
    html += feedHeaderHtml;
    _lastDayCoverLists = [];
