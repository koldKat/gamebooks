...
import { openCoverActivity, openSeriesActivity, _startLandingCoverRotation, _effectiveLandingCoverSource, loadCovers } from './covers.js?v=41';
import { t } from './i18n.js?v=10';
import { showConfirm, showTwoChoice } from './play.js?v=36';
