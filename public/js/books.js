...
import { refreshCoinsDisplay } from './shop.js?v=48';
import { openCoverActivity, openSeriesActivity, _startLandingCoverRotation, _resetLandingCoverQueue, _effectiveLandingCoverSource, loadCovers } from './covers.js?v=88';
import { t } from './i18n.js?v=34';
import { showConfirm, showTwoChoice } from './play.js?v=72';
import { escapeHtml, BATTLE_SIM_BOOK_IDS } from './util.js?v=41';
