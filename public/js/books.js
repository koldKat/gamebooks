...
import { refreshCoinsDisplay } from './shop.js?v=27';
import { openCoverActivity, openSeriesActivity, _startLandingCoverRotation, _effectiveLandingCoverSource, loadCovers } from './covers.js?v=50';
import { t } from './i18n.js?v=17';
import { showConfirm, showTwoChoice } from './play.js?v=45';
