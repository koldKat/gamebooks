...
import { openCoverActivity, openSeriesActivity, _startLandingCoverRotation, _resetLandingCoverQueue, _effectiveLandingCoverSource, loadCovers } from './covers.js?v=92';
import { t } from './i18n.js?v=36';
import { showConfirm, showTwoChoice } from './play.js?v=80';
import { escapeHtml, BATTLE_SIM_BOOK_IDS } from './util.js?v=45';
