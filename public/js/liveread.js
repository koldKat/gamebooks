...
import { navigate, commitChoices, showAlert, suppressAutoNav } from './play.js?v=159';
import { network, setLightweightRestabilize } from './graph.js?v=149';
import { t } from './i18n.js?v=74';
import { shortcutLabel, registerPanelShortcut, ALL_PANEL_OVERLAY_IDS } from './util.js?v=92';
