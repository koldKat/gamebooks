...
import { state, apiFetch, currentBookId, currentPlaythrough, currentSection, viewingPt, isTerminal, parseSecId } from './state.js?v=1467';
import { navigate, commitChoices, showAlert, suppressAutoNav } from './play.js?v=1467';
import { network, setLightweightRestabilize } from './graph.js?v=1467';
import { t } from './i18n.js?v=1467';
import { shortcutLabel, registerPanelShortcut, ALL_PANEL_OVERLAY_IDS } from './util.js?v=1467';
