...
import { initSim231, setSim231Visible, renderSim231 } from './battlesim/battlesim231.js';
import { initSim232, setSim232Visible, renderSim232 } from './battlesim/battlesim232.js';
import { initSim233, setSim233Visible, renderSim233 } from './battlesim/battlesim233.js';
...
import { initSim236, setSim236Visible, renderSim236 } from './battlesim/battlesim236.js';
import { initSim237, setSim237Visible, renderSim237 } from './battlesim/battlesim237.js';
import { initSim238, setSim238Visible, renderSim238 } from './battlesim/battlesim238.js';
import { initSim239, setSim239Visible, renderSim239 } from './battlesim/battlesim239.js';
...
import { initSim434, setSim434Visible, renderSim434 } from './battlesim/battlesim434.js';
import { initSim435, setSim435Visible, renderSim435 } from './battlesim/battlesim435.js';
import { initSim436, setSim436Visible, renderSim436 } from './battlesim/battlesim436.js';
import { initSim437, setSim437Visible, renderSim437 } from './battlesim/battlesim437.js';
...
function showLogin() {
  ...
  setSim231Visible(false);
  setSim232Visible(false);
  setSim233Visible(false);
  ...
  setSim236Visible(false);
  setSim237Visible(false);
  setSim238Visible(false);
  setSim239Visible(false);
  ...
  setSim434Visible(false);
  setSim435Visible(false);
  setSim436Visible(false);
  setSim437Visible(false);
...
async function showMain(bookId, isbn = null, issn = null, asin = null, cover = null, pdfPath = null, pages = null, authors = null, description = null, discoverableSections = null, isPublic = false, isCreator = true, seriesName = null, seriesNumber = null, isContainer = false, parentBookId = null, bookOrder = null) {
  ...
  setSim231Visible(bookId === 231);
  setSim232Visible(bookId === 232);
  setSim233Visible(bookId === 233);
  ...
  setSim236Visible(bookId === 236);
  setSim237Visible(bookId === 237);
  setSim238Visible(bookId === 238);
  setSim239Visible(bookId === 239);
  ...
  setSim434Visible(bookId === 434);
  setSim435Visible(bookId === 435);
  setSim436Visible(bookId === 436);
  setSim437Visible(bookId === 437);
