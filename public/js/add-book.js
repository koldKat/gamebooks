...
import { getCachedAllSeries, _refreshLibraryUi, setInvalidateAutocompleteCaches } from './books.js?v=151';
...
} from './autocomplete.js?v=142';
import { escapeHtml, compressImage } from './util.js?v=54';
