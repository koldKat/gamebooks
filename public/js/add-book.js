...
import { getCachedAllSeries, _refreshLibraryUi, setInvalidateAutocompleteCaches } from './books.js?v=66';
...
} from './autocomplete.js?v=58';
import { escapeHtml, compressImage } from './util.js?v=7';
