...
import { setTrailCollapsed, setChoicesRecordedCount, CHOICES_PULSE_THRESHOLD } from './play.js?v=59';
import { setCoversPrefsState, _updateLandingBgDragUi } from './covers.js?v=79';
import { setExpandedPrefs, renderBooksList, getCachedBooks, getCachedAllSeries, getCachedStashes } from './books.js?v=106';
