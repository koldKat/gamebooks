...
import { setTrailCollapsed, setChoicesRecordedCount, CHOICES_PULSE_THRESHOLD } from './play.js?v=38';
import { setCoversPrefsState, _updateLandingBgDragUi } from './covers.js?v=43';
import { setExpandedPrefs, renderBooksList, getCachedBooks, getCachedAllSeries, getCachedStashes } from './books.js?v=68';
